...
public class viewFriendRequest implements ActionListener {
	...
	public viewFriendRequest(JTextField tf1, JFrame frame1, Connection dbc) {
		this.frame = frame;
		this.dbc = dbc;
		this.username = tf1;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		// JPanel changingPanel = new MainPagePosts(dbc,username.getText());
		try {
			CallableStatement cs = this.dbc.prepareCall("call listOfFriendRequest(?,?)");
			...
			// i++;
			// }
			// System.out.println("this is a test for counting the total row of
			// the result set");
...
//				frame1.add(accept);
			...
			// System.out.println("this is a test for select the first row in
			// the result set");
