...
//		System.out.println(this.tf1.getText());
//		System.out.println(this.p1.getText());
//		String query = "jdbc:sqlserver://" + this.serverName+";databaseName="+this.databaseName+";user="+user+";password="+pass;		
		String query = "INSERT INTO person(UserName,PassHash) values ('" + this.tf1.getText()+"','"+this.p1.getText()+"');";
...
//			closeConnection.addActionListener(new ConnectionCloser(dbc));//but it's 3AM so that's beyond my abilites rn
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "Expection!!!! Run awwaayy from this terrible APPPPP");
		}
	}
